        ...
        <div class="container">
            <nav aria-label="breadcrumb" class="mb-5">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">Исторический жанр</li>
                </ol>
            </nav>

            <h3 class="mb-5 text-center">Галерея Исторический</h3>

            <div class="row">
                @foreach([
                    ['history01.png', 'Продавец воды', '40x60 см'],
                    ['history02.png', 'Чайхана', '50х70 см'],
                    ['history03.png', 'Чайхана--', '60х40 см'],
                    ['history04.png', 'Чайхана--', '50х70 см'],
                    ['history05.png', 'Мастер тандыра', '50х70 см'],
                ] as $item)
