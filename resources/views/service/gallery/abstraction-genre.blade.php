        ...
        <div class="container">
            <nav aria-label="breadcrumb" class="mb-5">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">Абстракция и инсталляции жанр</li>
                </ol>
            </nav>

            <h3 class="mb-5 text-center">Галерея Абстракция и инсталляции</h3>

            <div class="row">
                @foreach([
                    ['abstraction01.png', 'Абстрактная картина', '60х90 см'],
                    ['abstraction.png', 'Абстрактная картина', '60х80 см'],
                ] as $item)
